...
export const SERIES: Record<string, Series> = {
  ...
  agents: {
    ...
    parts: [
      ...
      { slug: "agent-architecture-compare", toy: "/playground/agent-compare/", published: true, title: { ko: "3. 아키텍처 비교 — 적재적소의 에이전트", en: "3. Architecture comparison — matching agents to tasks" } },
    ],
  },
};
