...
export const blocks: BiBlock[] = [
  ...
  },
  {
    ...
    code: [
      "        열0   열1        col0  col1",
      "      ┌            ┐",
      "  행0 │   2     0  │   ← 벡터 (2, 0)   row 0 → vector (2, 0)",
      "  행1 │   1     3  │   ← 벡터 (1, 3)   row 1 → vector (1, 3)",
      "      └            ┘",
    ].join("\n"),
  },
  {
  ...
  },
  {
    type: "code",
    code: [
      "행렬 × 벡터  (각 출력 성분 = 한 행 · 입력 벡터)",
      "matrix × vector  (each output component = one row · input)",
      "",
      "        W          x",
      "     [ 2  0 ]    [ 1 ]",
      "     [ 1  3 ]  · [ 2 ]  =   ?",
      "",
      "  행0 · x  (row 0):  2*1 + 0*2  =  2 + 0  =  2",
      "  행1 · x  (row 1):  1*1 + 3*2  =  1 + 6  =  7",
      "",
      "  W · x  =  [ 2, 7 ]",
      "",
      "입력을 옆에 하나 더 붙이면? 같은 내적을 그 열에도 한 번 더 돌릴 뿐.",
      "Add a second input beside it? Just run the same dot products on it too.",
      "",
      "     [ 2  0 ]    [ 1  0 ]      [ 2   0 ]",
      "     [ 1  3 ]  · [ 2  1 ]  =   [ 7   3 ]",
    ].join("\n"),
